...
type PropertyValueTypes  = {
	...
	debug: boolean;
	colorPalette: string;
	textStyle: "text-xs" | "text-sm" | "text-md" | "text-lg" | "text-xl" | "text-2xl" | "text-3xl" | "text-4xl" | "text-5xl" | "heading-2xs" | "heading-xs" | "heading-sm" | "heading-md" | "heading-lg" | "heading-xl";
}
